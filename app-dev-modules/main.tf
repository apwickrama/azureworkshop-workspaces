...
module "networking" {
  source  = "app.terraform.io/tfazapwickrama/networking/azurerm"
  version = "0.0.1"
...
module "webserver" {
  source  = "app.terraform.io/tfazapwickrama/webserver/azurerm"
  version = "0.0.1"
...
module "appserver" {
  source  = "app.terraform.io/tfazapwickrama/appserver/azurerm"
  version = "0.0.1"
...
module "dataserver" {
  source  = "app.terraform.io/tfazapwickrama/dataserver/azurerm"
  version = "0.0.1"
